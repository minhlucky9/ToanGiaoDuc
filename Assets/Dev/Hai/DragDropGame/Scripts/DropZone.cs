...
namespace DragDrop
{
    public class DropZone : MonoBehaviour
    {
        ...
        [Header("Điểm để chữa bài")]
        // Dùng để hiện các Draggable objects trong dropzone để chữa bài
        [SerializeField] private GameObject[] spawnPoints;
        // Object dùng để chữa bài
        [SerializeField] private GameObject correctingObject;
        ...
        public IEnumerator ShowAnswer()
        {
            ...
            for (int position = 0; position < requiredCount + offset; position++)
            {
                // Tạo draggable object mỗi 1s
                Instantiate(correctingObject, spawnPoints[position].transform.position, Quaternion.identity, gameObject.transform);
