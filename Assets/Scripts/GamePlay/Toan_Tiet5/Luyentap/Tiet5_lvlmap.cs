...
public class Tiet5_lvlmap : MonoBehaviour, LevelMap
{
    public int idLT = 1;
    public List<Tiet5_Inputs> inputList;
    [Header("Stats")]
    ...
    public void OnFinishLevel()
    {
        ...
        foreach (Tiet5_Inputs item in inputList)
        {
    ...
    IEnumerator StartTietHoc()
    {
        ...
        GetComponentInChildren<Tiet5_gp>().playAnimList();
