...
public class Tiet5_TuKT_lvlmap : MonoBehaviour, LevelMap
{
    public int idTuKT = 0;
    int rightCount = 0;
    int wrongCount = 0;
    ...
    void checkRight(List<Tiet5_Inputs> list)
    {
        foreach (Tiet5_Inputs item in list)
        {
    ...
    public void OnFinishLevel()
    {
        ...
        //calculate
        checkRight(GetComponentInChildren<Tiet5_TuKT>().InputA);
        checkRight(GetComponentInChildren<Tiet5_TuKT>().InputB);
        checkRight(GetComponentInChildren<Tiet5_TuKT>().InputAns);
        //Achievement
    ...
    IEnumerator StartTietHoc()
    {
        ...
        // TimeLine play
        TimeLineManage.INSTANCE.Tiet5("KT", idTuKT);
        double timeW1 = TimeLineManage.INSTANCE.GetDurationOfCurrentDirector();
        GetComponentInChildren<Tiet5_TuKT>().playAnimList();
