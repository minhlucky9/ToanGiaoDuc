...
public class SS_ItemMoveLT2 : MonoBehaviour
{
    ...
    [SerializeField]
    private SoSanh_LT2_lvlMap levelMap;
    Camera mainCam;
    private SS_AreaReceiverLT2 areaDad;
    ...
    public void RequestCheck()
    {
        ...
        {
            SS_AreaReceiverLT2 area = hit.transform.GetComponent<SS_AreaReceiverLT2>();
            if (areaDad != null)
            {
    ...
    public void SetAreaDad(SS_AreaReceiverLT2 area)
    {
        areaDad = area;
    }
